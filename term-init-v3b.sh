...
echo "Setting init.d selesai!"
echo ""
sleep 1
echo "DNSCrypt android installer by ewwink"
echo ""
sleep 1

cp run-dnscrypt.sh /system/bin/run-dnscrypt
chmod +x /system/bin/run-dnscrypt
chown 0.0 /system/bin/run-dnscrypt

cp -r android-arm /data/local/dnscrypt
